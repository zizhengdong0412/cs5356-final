...
import { z } from 'zod';
import { U as User } from '../../shared/better-auth.B3qlboSE.cjs';
...
interface OIDCOptions {
     ...
     */
    getAdditionalUserInfoClaim?: (user: User & Record<string, any>, scopes: string[]) => Record<string, any> | Promise<Record<string, any>>;
}
...
declare const oidcProvider: (options: OIDCOptions) => {
    ...
    hooks: {
        after: {
            matcher(): true;
            handler: (inputContext: better_call.MiddlewareInputContext<better_call.MiddlewareOptions>) => Promise<Response | undefined>;
        }[];
    };
    endpoints: {
        getOpenIdConfig: {
